...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb 14 15:42:42 2018
...
def readLangs(lang1, lang2, lang3, reverse=False):
    ...
    lines = open('data/%s-%s-%s.txt' % (lang1, lang2, lang3), encoding='utf-8').\
        read().strip().split('\n')
    ...
    if reverse:
        ...
        output_lang3 = Lang(lang3)

    return input_lang, output_lang, output_lang3, pairs
...
def filterPair(p):
    return len(p[0].split(' ')) < MAX_LENGTH and \
        len(p[1].split(' ')) < MAX_LENGTH and len(p[2].split(' ')) < MAX_LENGTH
...
def prepareData(lang1, lang2, lang3, reverse=False):
    input_lang, output_lang, output_lang3, pairs = readLangs(lang1, lang2, lang3, reverse)
    ...
    for pair in pairs:
        ...
        output_lang3.addSentence(pair[2])
    print("Counted words:")
